...
final class FlowBridgeSNNSmokeTests: XCTestCase {
    func testSimulateReturnsBins() {
        let cfg = FlowConfig(
            ...
            dynamics: .init(radialBias: 0.2, spikeKick: 0.5, noiseStdPos: 0.01, noiseStdDir: 0.05, maxSpeed: 1.0, energyAlpha: 0.9, energyFloor: 1e-6, energySpikeGain: 0.0, energyCap: 0.0)
        )
