...
final class FlowRouterTests: XCTestCase {
    func testRunProjectsToBins() {
        let cfg = FlowConfig(
            ...
            dynamics: .init(radialBias: 0.2, spikeKick: 0.5, gainSpikeKickScale: 0.0, noiseStdPos: 0.0, noiseStdDir: 0.0, maxSpeed: 1.0, energyAlpha: 0.95, energyFloor: 1e-5, energySpikeGain: 0.0, energyGainBias: 0.0, energyCap: 0.0)
        )
