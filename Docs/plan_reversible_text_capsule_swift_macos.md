...
- **Простое отображение капсюля в массив «энергий»**: базовая позиционная система счисления (по умолчанию — **base‑256**) даёт числа `1..256` (при необходимости читаемости алфавит можно сузить).  
